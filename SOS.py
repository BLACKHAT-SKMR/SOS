...
def ua_valid():
	...
	bulid = random.choice(["Redmi Note10 Pro","Honor Play 4T","S10 Pro","GIONEE P15","Primo GH10","Gplus P10","Mate30 RS","M2011J18C"])
	apk = str(random.randint(300,450))+".1.0.36."+str(random.randint(90,150))
	app = random.randint(450000000,490000000)
	tec = f"Mozilla/5.0 (Linux; Android {androversi}; {bulid}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(50,105))}.0.{str(rr(1111,4444))}.{str(rr(45,250))} Mobile Safari/537.36"
	nit = f"Dalvik/2.1.0 (Linux; U; Android {androversi}; Nitro 55A Build/RP1A.201005.001) [FBAN/Orca-Android;FBAV/{apk};FBPN/com.facebook.orca;FBLC/in_ID;FBBV/{app};FBCR/Telkomsel;FBMF/samsung;FBBD/samsung;FBDV/SM-A530F;FBSV/9;FBCA/arm64-v8a:null;FBDM/"+"{density=3.0,width=1080,height=2076};FB_FW/1;] FBBK/1"
	return rc([tec, nit])
